...
describe Notification do
  ...
  it "should create the subject correctly for an endorsement request" do
    @endorsement_request = Factory.build(:endorsement_request)
    @endorsement_request.stub!(:id).and_return(1)
    @notification = Notification.create_endorsement_request(@endorsement_request,@endorsement_request.recipients.first)
